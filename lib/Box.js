...
var Box = (function () {
  ...
  proto.print_ = function (boxLeft, startColumn) {
    ...
    // (structural "hov" box) always breaks the line.  But the result of our test indicate
    // that the description is not valid.  We here disable the behavior by the following flag.
