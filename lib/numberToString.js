...
function numberToString(num, flags, width, prec, type) {
  ...
  function toExponential(num, prec, upper) {
    var ret = prec ? num.toExponential(prec) : num.toExponential();
